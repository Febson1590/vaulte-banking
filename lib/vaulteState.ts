...
// ─── Demo date helper — keeps DEMO_STATE always fresh relative to today ────────
// Computed at module-load time (client side) so 7D / 1M / 3M filters always work.
function _demoAgo(days: number, hour = 12, minute = 0): string {
  const d = new Date();
...
export const DEMO_STATE: VaulteState = {
  ...
  transactions: [
    // ── 7D window (1–6 days ago) ─────────────────────────────────────────────
    { id: "tx-001", txType: "crypto_deposit",  type: "credit", name: "Bitcoin Deposit",       sub: "External Wallet",      amount: 0.050,   fee: 0,     balanceAfter: 0.184,   currency: "BTC", date: _demoAgo(1, 14, 14), category: "Crypto",        badge: "Crypto",    badgeBg: "#FFFBEB", badgeBorder: "#FDE68A", badgeColor: "#D97706", status: "completed", accountId: "acc-004", icon: "₿",  iconBg: "linear-gradient(135deg,#F59E0B,#D97706)", iconColor: "#fff",     reference: "VLT-2026-83947" },
    { id: "tx-002", txType: "withdrawal",       type: "debit",  name: "ATM Withdrawal",        sub: "Chase Bank · NYC",     amount: 200.00,  fee: 2.50,  balanceAfter: 4840.00, currency: "USD", date: _demoAgo(2, 10, 30), category: "Cash",          badge: "Cash",      badgeBg: "#EFF6FF", badgeBorder: "#BFDBFE", badgeColor: "#2563EB", status: "completed", accountId: "acc-001", icon: "🏧", iconBg: "linear-gradient(135deg,#DBEAFE,#BFDBFE)", iconColor: "#2563EB", reference: "VLT-2026-73821" },
    { id: "tx-003", txType: "transfer_in",      type: "credit", name: "Transfer Received",     sub: "From Sarah L.",        amount: 1000.00, fee: 0,     balanceAfter: 5040.00, currency: "USD", date: _demoAgo(4, 16, 45), category: "Transfer",      badge: "Incoming",  badgeBg: "#F0FDF4", badgeBorder: "#BBF7D0", badgeColor: "#16A34A", status: "completed", accountId: "acc-001", icon: "↙",  iconBg: "linear-gradient(135deg,#D1FAE5,#A7F3D0)", iconColor: "#059669", reference: "VLT-2026-62910", recipientName: "Sarah L." },
    { id: "tx-004", txType: "card_payment",     type: "debit",  name: "Netflix Subscription",  sub: "Netflix Inc.",         amount: 15.99,   fee: 0,     balanceAfter: 4040.00, currency: "USD", date: _demoAgo(6,  9,  0), category: "Entertainment", badge: "Card",      badgeBg: "#FEF2F2", badgeBorder: "#FECACA", badgeColor: "#DC2626", status: "completed", accountId: "acc-001", icon: "▶",  iconBg: "linear-gradient(135deg,#FEE2E2,#FECACA)", iconColor: "#DC2626", reference: "VLT-2026-51847" },
    // ── 1M window only (9–29 days ago) ──────────────────────────────────────
    { id: "tx-005", txType: "card_payment",     type: "debit",  name: "Whole Foods Market",    sub: "Grocery Store",        amount: 87.50,   fee: 0,     balanceAfter: 4056.00, currency: "USD", date: _demoAgo(9, 13, 22), category: "Food",          badge: "Card",      badgeBg: "#F0FDF4", badgeBorder: "#BBF7D0", badgeColor: "#16A34A", status: "completed", accountId: "acc-001", icon: "🛒", iconBg: "linear-gradient(135deg,#D1FAE5,#A7F3D0)", iconColor: "#059669", reference: "VLT-2026-49321" },
    { id: "tx-006", txType: "deposit",          type: "credit", name: "Salary Deposit",        sub: "Acme Corp Ltd.",       amount: 3500.00, fee: 0,     balanceAfter: 4143.50, currency: "USD", date: _demoAgo(14, 9,  0), category: "Income",        badge: "Deposit",   badgeBg: "#EFF6FF", badgeBorder: "#BFDBFE", badgeColor: "#2563EB", status: "completed", accountId: "acc-001", icon: "💼", iconBg: "linear-gradient(135deg,#EEF4FF,#DBEAFE)", iconColor: "#1A73E8", reference: "VLT-2026-38104" },
    { id: "tx-007", txType: "card_payment",     type: "debit",  name: "Amazon Purchase",       sub: "Amazon.com",           amount: 124.99,  fee: 0,     balanceAfter: 643.50,  currency: "USD", date: _demoAgo(22, 15, 40), category: "Shopping",     badge: "Card",      badgeBg: "#FFFBEB", badgeBorder: "#FDE68A", badgeColor: "#D97706", status: "completed", accountId: "acc-001", icon: "📦", iconBg: "linear-gradient(135deg,#FFFBEB,#FDE68A)", iconColor: "#D97706", reference: "VLT-2026-27658" },
    // ── 3M window only (33–89 days ago) ─────────────────────────────────────
    { id: "tx-008", txType: "card_payment",     type: "debit",  name: "Uber Ride",             sub: "Uber Technologies",    amount: 12.50,   fee: 0,     balanceAfter: 768.50,  currency: "USD", date: _demoAgo(33, 20, 15), category: "Transport",    badge: "Card",      badgeBg: "#F8FAFC", badgeBorder: "#E2E8F0", badgeColor: "#64748B", status: "completed", accountId: "acc-001", icon: "🚗", iconBg: "linear-gradient(135deg,#F1F5F9,#E2E8F0)", iconColor: "#374151", reference: "VLT-2026-19044" },
    { id: "tx-009", txType: "card_payment",     type: "debit",  name: "Spotify Premium",       sub: "Spotify AB",           amount: 9.99,    fee: 0,     balanceAfter: 781.00,  currency: "USD", date: _demoAgo(45,  0,  0), category: "Entertainment", badge: "Card",      badgeBg: "#F0FDF4", badgeBorder: "#BBF7D0", badgeColor: "#16A34A", status: "completed", accountId: "acc-001", icon: "🎵", iconBg: "linear-gradient(135deg,#D1FAE5,#A7F3D0)", iconColor: "#059669", reference: "VLT-2026-10293" },
    { id: "tx-010", txType: "deposit",          type: "credit", name: "Freelance Payment",     sub: "Client · Web Project", amount: 750.00,  fee: 0,     balanceAfter: 790.99,  currency: "USD", date: _demoAgo(58, 11, 30), category: "Income",       badge: "Deposit",   badgeBg: "#EFF6FF", badgeBorder: "#BFDBFE", badgeColor: "#2563EB", status: "completed", accountId: "acc-001", icon: "💻", iconBg: "linear-gradient(135deg,#EEF4FF,#DBEAFE)", iconColor: "#1A73E8", reference: "VLT-2026-00847" },
    { id: "tx-011", txType: "exchange",         type: "debit",  name: "Currency Exchange",     sub: "USD → EUR",            amount: 500.00,  fee: 1.50,  balanceAfter: 40.99,   currency: "USD", date: _demoAgo(72,  9, 15), category: "Exchange",     badge: "Exchange",  badgeBg: "#EEF4FF", badgeBorder: "#C4B5FD", badgeColor: "#7C3AED", status: "completed", accountId: "acc-001", icon: "⇄",  iconBg: "linear-gradient(135deg,#EEF4FF,#C4B5FD)", iconColor: "#7C3AED", reference: "VLT-2026-99201" },
    { id: "tx-012", txType: "transfer_out",     type: "debit",  name: "Wire Transfer",         sub: "To James Wilson",      amount: 300.00,  fee: 15.00, balanceAfter: 540.99,  currency: "USD", date: _demoAgo(84, 14,  0), category: "Transfer",     badge: "Transfer",  badgeBg: "#EFF6FF", badgeBorder: "#BFDBFE", badgeColor: "#2563EB", status: "completed", accountId: "acc-001", icon: "↗",  iconBg: "linear-gradient(135deg,#DBEAFE,#BFDBFE)", iconColor: "#2563EB", reference: "VLT-2026-88742", recipientName: "James Wilson", recipientBank: "Wells Fargo" },
  ],
  recipients: [
  ...
  notifications: [
    { id: "notif-001", type: "transaction", title: "Salary Received",          message: "Your salary of $3,500.00 from Acme Corp Ltd. has been credited to your Primary USD Account.",          date: _demoAgo(14,  9,  1), read: false, icon: "💼", iconBg: "#EEF4FF", iconColor: "#1A73E8" },
    { id: "notif-002", type: "security",    title: "New Login Detected",        message: "A new login was detected from Chrome on Windows · New York, US. If this wasn't you, secure your account immediately.", date: _demoAgo(4,  8, 15), read: false, icon: "🔐", iconBg: "#FEF2F2", iconColor: "#DC2626" },
    { id: "notif-003", type: "transaction", title: "Transfer Received",         message: "Sarah Johnson sent you $1,000.00. The funds are now available in your Primary USD Account.",             date: _demoAgo(4, 16, 45), read: false, icon: "↙",  iconBg: "#F0FDF4", iconColor: "#16A34A" },
    { id: "notif-004", type: "account",     title: "KYC Verification Complete", message: "Your identity has been verified successfully. You now have full access to all Vaulte features.",         date: _demoAgo(6, 10,  0), read: true,  icon: "✓",  iconBg: "#F0FDF4", iconColor: "#059669" },
    { id: "notif-005", type: "account",     title: "Spending Limit Alert",      message: "You have used 80% ($1,205.48 of $2,000.00) of your monthly card spending limit.",                        date: _demoAgo(9, 20,  0), read: true,  icon: "⚠",  iconBg: "#FFFBEB", iconColor: "#D97706" },
    { id: "notif-006", type: "promo",       title: "Better Exchange Rates",     message: "Send money abroad with zero fees this weekend. EUR and GBP rates updated.",                              date: _demoAgo(12, 12,  0), read: true,  icon: "🎁", iconBg: "#EEF4FF", iconColor: "#7C3AED" },
    { id: "notif-007", type: "security",    title: "Password Changed",          message: "Your account password was changed. If you did not make this change, contact support immediately.",        date: _demoAgo(22, 14, 20), read: true,  icon: "🔑", iconBg: "#F0FDF4", iconColor: "#059669" },
    { id: "notif-008", type: "account",     title: "Card Expiry Reminder",      message: "Your Vaulte Virtual Card expires in 60 days. Request a new card to avoid disruption.",                   date: _demoAgo(55,  9,  0), read: true,  icon: "📅", iconBg: "#FEF2F2", iconColor: "#DC2626" },
  ],
