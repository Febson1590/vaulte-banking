...
// ── Country dataset ─────────────────────────────────────────────────────────
// Pre-sorted A→Z by country name. The .sort() below is a programmatic safety
// net; the source order already matches the expected A→Z sequence.
// Sort key  = value  (plain English name, no emoji)
// Render    = label  (flag emoji + name)
// No special-casing, no manual pins, no region grouping.
