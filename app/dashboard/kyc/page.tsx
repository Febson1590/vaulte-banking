...
const NATIONALITIES = [
  ...
  "Austrian", "Azerbaijani", "Bangladeshi", "Belgian", "Bolivian", "Brazilian",
  "British", "Bulgarian", "Cameroonian", "Canadian", "Chilean", "Chinese",
  "Colombian", "Croatian", "Cuban", "Czech", "Danish", "Dutch", "Egyptian",
  "Emirati", "Ethiopian", "Filipino", "Finnish", "French", "Georgian",
  "German", "Ghanaian", "Greek", "Guatemalan", "Hungarian", "Indian",
  "Indonesian", "Iranian", "Iraqi", "Irish", "Israeli", "Italian", "Ivorian",
  "Jamaican", "Japanese", "Jordanian", "Kazakhstani", "Kenyan", "Korean",
  "Lebanese", "Libyan", "Malaysian", "Mexican", "Moroccan", "Mozambican",
  "Namibian", "Nepali", "New Zealander", "Nigerian", "Norwegian", "Pakistani",
  "Peruvian", "Polish", "Portuguese", "Romanian", "Russian", "Saudi",
  "Senegalese", "Serbian", "Singaporean", "South African", "Spanish",
  "Sri Lankan", "Sudanese", "Swedish", "Swiss", "Syrian", "Taiwanese",
  "Tanzanian", "Thai", "Tunisian", "Turkish", "Ugandan", "Ukrainian",
          ...
          <div style={{ background: C.card, borderRadius: 20, border: `1px solid ${C.border}`, boxShadow: C.shadow, padding: "32px 32px 28px" }}>
            ...
            <div className="kyc-form-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "18px 20px" }}>
              ...
              <div style={{ gridColumn: "1 / -1" }}>
                ...
                <input value={form.city} placeholder="e.g. Lagos, Nigeria"
