...
const transactions = [
  { icon: "₿",  iconBg: "linear-gradient(135deg,#F59E0B,#D97706)", iconColor: "#fff",     name: "Bitcoin Purchase",   sub: "Crypto.com",    date: "Today, 2:14 PM",  amount: "−$500.00",   color: "#EF4444", badge: "Crypto",   badgeBg: "#FFFBEB", badgeBorder: "#FDE68A", badgeColor: "#D97706" },
  { icon: "🏧", iconBg: "linear-gradient(135deg,#DBEAFE,#BFDBFE)", iconColor: "#2563EB",  name: "ATM Withdrawal",     sub: "Chase Bank",    date: "Today, 10:30 AM", amount: "−$200.00",   color: "#EF4444", badge: "Cash",     badgeBg: "#EFF6FF", badgeBorder: "#BFDBFE", badgeColor: "#2563EB" },
  { icon: "↗",  iconBg: "linear-gradient(135deg,#D1FAE5,#A7F3D0)", iconColor: "#059669",  name: "Transfer Received",  sub: "From Sarah L.", date: "Yesterday",       amount: "+$1,000.00", color: "#059669", badge: "Incoming", badgeBg: "#F0FDF4", badgeBorder: "#BBF7D0", badgeColor: "#16A34A" },
];
...
export default function Dashboard() {
  ...
  const liftCard = (e: React.MouseEvent<HTMLElement>) => {
    e.currentTarget.style.boxShadow = C.shadowHv;
    e.currentTarget.style.transform = "translateY(-2px)";
  };
  const dropCard = (e: React.MouseEvent<HTMLElement>) => {
  ...
  return (
    <div style={{ display: "flex", minHeight: "100vh", background: C.bg, fontFamily: "'Inter', -apple-system, BlinkMacSystemFont, sans-serif" }}>
      ...
      <aside style={{
        ...
        zIndex: 100,
        boxShadow: "2px 0 32px rgba(15,23,42,0.2)",
      }}>
          ...
          {navItems.map(item => (
            ...
            >
              <div style={{ display: "flex", alignItems: "center", gap: 11 }}>
                <span style={{ fontSize: 14, color: item.active ? "#fff" : "rgba(255,255,255,0.35)", lineHeight: 1 }}>{item.icon}</span>
                <span style={{
        ...
        <div style={{
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 10 }}>
            <div>
              ...
              <p style={{ fontSize: 21, fontWeight: 800, color: "#fff", letterSpacing: "-0.8px", lineHeight: 1 }}>$12,540.75</p>
            </div>
            ...
            {currencies.map((c, i) => (
              <div key={i} style={{
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                  ...
                  <span style={{ fontSize: 11.5, color: "rgba(255,255,255,0.38)", fontWeight: 500 }}>{c.code}</span>
                </div>
                <div style={{ textAlign: "right" }}>
                  <p style={{ fontSize: 12, color: "rgba(255,255,255,0.82)", fontWeight: 600 }}>{c.balance}</p>
                  {c.sub && <p style={{ fontSize: 10, color: "rgba(255,255,255,0.25)", marginTop: 1 }}>{c.sub}</p>}
                </div>
              </div>
            ))}
          </div>
      ...
      <div style={{ flex: 1, marginLeft: 236, display: "flex", flexDirection: "column", minHeight: "100vh" }}>
        ...
        <header style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 20 }}>
            <div>
              <p style={{ fontSize: 15.5, fontWeight: 700, color: C.text, lineHeight: 1.2, letterSpacing: "-0.2px" }}>Dashboard</p>
              <p style={{ fontSize: 11.5, color: C.muted, fontWeight: 400, marginTop: 1 }}>Monday, March 10, 2025</p>
            </div>
            <div style={{ width: 1, height: 26, background: C.border }} />
            <div style={{ position: "relative", width: 240 }}>
              <span style={{ position: "absolute", left: 12, top: "50%", transform: "translateY(-50%)", fontSize: 12, color: C.muted, lineHeight: 1, pointerEvents: "none" }}>⌕</span>
              <input placeholder="Search transactions, accounts…" style={{
                ...
                fontFamily: "inherit", transition: "border-color 0.18s, box-shadow 0.18s, background 0.18s",
              }}
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
            ...
            >
              🔔
              <span style={{ position: "absolute", top: 8, right: 8, width: 6, height: 6, background: "#EF4444", borderRadius: "50%", border: "1.5px solid #fff" }} />
            </button>
            ...
            <div style={{
              ...
              onMouseEnter={e => { (e.currentTarget as HTMLElement).style.background = C.bg; (e.currentTarget as HTMLElement).style.borderColor = "rgba(15,23,42,0.11)"; }}
              onMouseLeave={e => { (e.currentTarget as HTMLElement).style.background = "transparent"; (e.currentTarget as HTMLElement).style.borderColor = C.border; }}
            >
              <div style={{
                ...
                boxShadow: "0 0 0 2px rgba(26,115,232,0.18)",
              }}>JD</div>
              <div style={{ lineHeight: 1 }}>
                <p style={{ fontSize: 13, fontWeight: 600, color: C.text, letterSpacing: "-0.1px" }}>John Doe</p>
        ...
        <main style={{ flex: 1, padding: "28px 32px 40px", overflowY: "auto" }}>
          ...
          <div style={{
            ...
            <div style={{ position: "relative" }}>
              ...
              <p style={{ fontSize: 13.5, color: C.sub, fontWeight: 400 }}>Here&apos;s an overview of your account.</p>
            </div>
            {/* Phone mockup */}
            <div style={{ position: "relative", flexShrink: 0 }}>
              ...
              <div style={{
                ...
                boxShadow: "0 24px 48px rgba(15,23,42,0.28)", position: "relative", overflow: "hidden", zIndex: 1,
              }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 292px", gap: 20, alignItems: "start" }}>
                ...
                <div style={{ padding: "26px 28px 28px" }}>
                  ...
                  <div style={{ display: "flex", alignItems: "baseline", gap: 12, marginBottom: 24 }}>
                    ...
                    <span style={{
                      ...
                      borderRadius: 8, padding: "4px 10px", letterSpacing: "0.01em", flexShrink: 0,
                    }}>▲ +$26.00 today</span>
                  </div>
                  ...
                  <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 24 }}>
                    ...
                    <div>
                      ...
                      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }}>
                        {[
                          { icon: "↗", label: "Send",     color: "#1A73E8", bg: "#EEF4FF", shadowC: "rgba(26,115,232,0.2)"  },
                          { icon: "↙", label: "Request",  color: "#7C3AED", bg: "#F5F3FF", shadowC: "rgba(124,58,237,0.2)"  },
                          { icon: "⇄", label: "Exchange", color: "#059669", bg: "#ECFDF5", shadowC: "rgba(5,150,105,0.2)"   },
                          { icon: "＋", label: "Add",      color: "#D97706", bg: "#FFFBEB", shadowC: "rgba(217,119,6,0.2)"   },
                        ].map(a => (
                          <button key={a.label} style={{
                            ...
                            onMouseEnter={e => {
                              ...
                              el.style.boxShadow = `0 8px 20px ${a.shadowC}`;
                            }}
                            onMouseLeave={e => {
                              const el = e.currentTarget as HTMLElement;
                      ...
                      {[
                        ...
                        <div key={i} style={{
                          ...
                          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                            ...
                            <div>
                              <p style={{ fontSize: 13.5, fontWeight: 600, color: C.text, lineHeight: 1.25 }}>{c.balance}</p>
                              {c.sub && <p style={{ fontSize: 11, color: C.muted, marginTop: 2 }}>{c.sub}</p>}
                            </div>
                          </div>
                          <div style={{ textAlign: "right" }}>
                            <p style={{ fontSize: 11.5, color: C.sub, fontWeight: 500, marginBottom: 3 }}>{c.code}</p>
                            <span style={{
                              fontSize: 11, fontWeight: 700,
                              color: c.up ? "#059669" : "#EF4444",
                              background: c.up ? "#ECFDF5" : "#FEF2F2",
                              border: `1px solid ${c.up ? "#A7F3D0" : "#FECACA"}`,
                  ...
                  <div style={{ position: "relative", height: 160, paddingLeft: 36 }}>
                    ...
                    {[250, 500, 750, 1000].map(v => (
                      <div key={v} style={{
                        ...
                        bottom: `${(v / maxSpend) * 130}px`,
                        borderTop: "1px dashed rgba(15,23,42,0.055)",
                      }} />
                    ))}
                    {/* Bars */}
                        ...
                        return (
                          <div key={i} style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", position: "relative", height: "100%" }}>
                            ...
                            <div style={{
                              ...
                              height: barH,
                              background: isToday
                                ? "linear-gradient(180deg, #60A5FA 0%, #1A73E8 100%)"
                                : "linear-gradient(180deg, #BFDBFE 0%, #93C5FD 100%)",
                              borderRadius: "5px 5px 0 0",
                              cursor: "pointer",
                              transition: "opacity 0.18s",
                              boxShadow: isToday ? "0 4px 14px rgba(26,115,232,0.28)" : "none",
                            }}
                ...
                <div style={{ padding: "26px 28px" }}>
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 20 }}>
                    ...
                    <Link href="/dashboard/transactions" style={{
                      fontSize: 12.5, color: C.blue, textDecoration: "none", fontWeight: 600,
                    ...
                    >
                      <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
                        ...
                        <div style={{
                          ...
                          display: "flex", alignItems: "center", justifyContent: "center",
                          fontSize: 18, color: tx.iconColor, flexShrink: 0,
                        ...
                        <div>
                          <div style={{ display: "flex", alignItems: "center", gap: 7, marginBottom: 4 }}>
                            ...
                            <span style={{
                              ...
                              border: `1px solid ${tx.badgeBorder}`,
                      ...
                      <div style={{ textAlign: "right", flexShrink: 0 }}>
                        <p style={{ fontSize: 15, fontWeight: 700, color: tx.color, letterSpacing: "-0.3px" }}>{tx.amount}</p>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
              ...
              >
                ...
                {/* Amount input */}
                <div style={{
                  background: C.bg, borderRadius: 14, padding: "12px 16px", marginBottom: 12,
                ...
                <button style={{
                  ...
                  boxShadow: "0 4px 16px rgba(26,115,232,0.28)",
                  letterSpacing: "0.01em",
                }}
                  onMouseEnter={e => {
                    (e.currentTarget as HTMLElement).style.boxShadow = "0 8px 24px rgba(26,115,232,0.38)";
                    (e.currentTarget as HTMLElement).style.transform = "translateY(-2px)";
                  }}
                  onMouseLeave={e => {
                    (e.currentTarget as HTMLElement).style.boxShadow = "0 4px 16px rgba(26,115,232,0.28)";
              ...
              <div style={{
                ...
                borderRadius: 20,
                padding: "22px 20px",
                boxShadow: "0 8px 32px rgba(30,64,175,0.32), 0 0 0 1px rgba(255,255,255,0.06)",
                position: "relative", overflow: "hidden",
                transition: "transform 0.25s ease, box-shadow 0.25s ease",
              }}
                onMouseEnter={e => {
                  (e.currentTarget as HTMLElement).style.transform = "translateY(-4px)";
                  (e.currentTarget as HTMLElement).style.boxShadow = "0 18px 48px rgba(30,64,175,0.4), 0 0 0 1px rgba(255,255,255,0.1)";
                }}
                onMouseLeave={e => {
                  (e.currentTarget as HTMLElement).style.transform = "translateY(0)";
                  (e.currentTarget as HTMLElement).style.boxShadow = "0 8px 32px rgba(30,64,175,0.32), 0 0 0 1px rgba(255,255,255,0.06)";
                }}
              >
                {/* Texture circles */}
                ...
                <div style={{
                  ...
                  boxShadow: "inset 0 1px 3px rgba(255,255,255,0.3), 0 2px 6px rgba(0,0,0,0.28)",
                  position: "relative",
                }}>
                  ...
                  <div style={{ position: "absolute", top: "25%", left: "25%", right: "25%", bottom: "25%", border: "0.5px solid rgba(100,50,0,0.18)", borderRadius: 2 }} />
                </div>
              ...
              >
                ...
                {[
                  ...
                  { label: "2FA Security",      status: "Enabled",   color: "#1A73E8", bg: "#EEF4FF", dot: "#60A5FA", dotRing: "rgba(96,165,250,0.2)"  },
                  { label: "Card Status",        status: "Active",    color: "#059669", bg: "#ECFDF5", dot: "#22C55E", dotRing: "rgba(34,197,94,0.2)"  },
                ].map((item, i) => (
                  <div key={i} style={{
                    display: "flex", justifyContent: "space-between", alignItems: "center",
                    padding: "11px 0",
