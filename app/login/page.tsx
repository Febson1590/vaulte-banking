...
export default function LoginPage() {
  ...
  return (
    <div style={{
      ...
      {/* Decorative blobs */}
      <div style={{ position: "absolute", top: "5%", left: "8%", width: 180, height: 180, background: "rgba(26,115,232,0.12)", borderRadius: "50%", filter: "blur(40px)" }} />
      <div style={{ position: "absolute", bottom: "10%", right: "5%", width: 220, height: 220, background: "rgba(26,115,232,0.1)", borderRadius: "50%", filter: "blur(50px)" }} />
      <div style={{ position: "absolute", top: "30%", right: "12%", width: 120, height: 120, background: "rgba(255,255,255,0.4)", borderRadius: "50%", filter: "blur(30px)" }} />

      {/* Floating decorative elements */}
      <div style={{ position: "absolute", top: "12%", right: "22%", fontSize: 36, filter: "drop-shadow(0 8px 16px rgba(26,115,232,0.3))", transform: "rotate(15deg)" }}>💰</div>
      <div style={{ position: "absolute", top: "8%", right: "8%", fontSize: 28, filter: "drop-shadow(0 6px 12px rgba(26,115,232,0.25))", transform: "rotate(-10deg)" }}>💰</div>
      <div style={{ position: "absolute", bottom: "20%", right: "6%", fontSize: 32, filter: "drop-shadow(0 8px 16px rgba(26,115,232,0.3))", transform: "rotate(8deg)" }}>📱</div>
      <div style={{ position: "absolute", bottom: "8%", right: "18%", fontSize: 30, filter: "drop-shadow(0 6px 12px rgba(26,115,232,0.25))", transform: "rotate(-15deg)" }}>💳</div>
      <div style={{ position: "absolute", top: "15%", left: "6%", fontSize: 28, filter: "drop-shadow(0 6px 12px rgba(26,115,232,0.2))", transform: "rotate(5deg)" }}>🛡️</div>
      ...
      <div style={{
        ...
        <div style={{ padding: "32px" }}>
          <h1 style={{ fontSize: 24, fontWeight: 800, color: "#0F172A", textAlign: "center", marginBottom: 28, letterSpacing: "-0.5px" }}>
            Login to Vaulte
          </h1>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div style={{ marginBottom: 18 }}>
              ...
              <div style={{ position: "relative" }}>
                <span style={{ position: "absolute", left: 14, top: "50%", transform: "translateY(-50%)", color: "#9CA3AF", fontSize: 16 }}>✉️</span>
                <input
                  ...
                  style={{
                    ...
                    background: "#F9FAFB", outline: "none", boxSizing: "border-box", transition: "border-color 0.2s",
                  }}
            ...
            <div style={{ display: "flex", gap: 12, justifyContent: "center" }}>
              <button type="button" style={{
                ...
                fontSize: 24, transition: "all 0.2s", boxShadow: "0 2px 8px rgba(0,0,0,0.06)",
              }}
