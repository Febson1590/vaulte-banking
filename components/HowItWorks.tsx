...
export default function HowItWorks() {
  return (
    <section id="how-it-works" style={{ padding: "24px 5%", background: "#F8FAFC" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr auto 1fr auto 1fr", gap: 0, alignItems: "center" }}>
          {steps.map((step, i) => (
            <React.Fragment key={step.num}>
              <div style={{ background: "#fff", borderRadius: 16, padding: "32px 24px", border: "1.5px solid #E5E7EB", boxShadow: "0 2px 10px rgba(0,0,0,0.04)", textAlign: "center" }}>
